        ...
        jClocksGMT: function( options ) 
        {
            ...
            return this.each(function()
            {
                ...
                if( options.analog )
                {
                    ...
                    // create hour hand
                    $("<div />", { class: "jcgmt-rotatingWrapper" }).append($("<img />", { class: "jcgmt-hour", src: options.imgpath + "assets/images/jcgmt-" + options.skin + "-clock_hour.svg" })).appendTo("#" + id + ' .jcgmt-clockHolder');
                    // create min hand
                    $("<div />", { class: "jcgmt-rotatingWrapper" }).append($("<img />", { class: "jcgmt-min", src: options.imgpath + "assets/images/jcgmt-" + options.skin + "-clock_min.svg" })).appendTo("#" + id + ' .jcgmt-clockHolder');
                    // create sec hand
                    $("<div />", { class: "jcgmt-rotatingWrapper" }).append($("<img />", { class: "jcgmt-sec", src: options.imgpath + "assets/images/jcgmt-" + options.skin + "-clock_sec.svg" })).appendTo("#" + id + ' .jcgmt-clockHolder');
                    // create clock face
                    $("<div />", { class: "jcgmt-clock"}).appendTo("#" + id + ' .jcgmt-clockHolder');
                }
