!(function (t) {
    ...
    var a = "intlTelInput",
        ...
        r = { UP: 38, DOWN: 40, ENTER: 13, ESC: 27, PLUS: 43, A: 65, Z: 90, SPACE: 32, TAB: 9 };
    function l(i, e) {
    ...
    t(i).load(function () {
        ...
        (l.prototype = {
            ...
            _filterCountries: function (i, e) {
                var n;
                for (n = 0; n < i.length; n++) i[n] = i[n].toLowerCase();
                for (n = 0, this.countries = []; n < u.length; n++) e(t.inArray(u[n].iso2, i)) && this.countries.push(u[n]);
            },
            ...
            _processCountryCodes: function () {
                ...
                for (var t = 0; t < this.countries.length; t++) {
                    ...
                    if ((this._addCountryCode(i.iso2, i.dialCode, i.priority), i.areaCodes)) for (var e = 0; e < i.areaCodes.length; e++) this._addCountryCode(i.iso2, i.dialCode + i.areaCodes[e]);
                }
            },
        ...
        _generateMarkup: function () {
            ...
            this.options.allowDropdown && (i += " allow-dropdown"),
                ...
                (this.flagsContainer = t("<div>", { class: "flag-container" }).insertBefore(this.telInput));

            var e = t("<div>", { class: "selected-flag" });
            e.appendTo(this.flagsContainer),
                (this.selectedFlagInner = t("<div>", { class: "iti-flag" }).appendTo(e)),
                this.options.separateDialCode && (this.selectedDialCode = t("<div>", { class: "selected-dial-code" }).appendTo(e));
            ...
            if (this.options.allowDropdown) {
                ...
                // ✅ Add Search Box as first item
                this.countryList.append(
                    '<li class="country-search"><input type="text" id="country-search" class="rounded-0 border-none form-control" placeholder="Search..." style="width:100%;padding:10px;"></li>'
                );
                ...
                this.options.dropdownContainer
                    ? (this.dropdown = t("<div>", { class: "intl-tel-input iti-container" }).append(this.countryList))
            ...
            _appendListItems: function (t, i) {
                for (var e = "", n = 0; n < t.length; n++) {
                    ...
                    (e += "<li class='country " + i + "' data-dial-code='" + a.dialCode + "' data-country-code='" + a.iso2 + "'>"),
                        (e += "<div class='flag-box'><div class='iti-flag " + a.iso2 + "'></div></div>"),
            ...
            _initDropdownListeners: function () {
                ...
                i.length &&
                    ...
                    this.flagsContainer.on("keydown" + t.ns, function (i) {
                        t.countryList.hasClass("hide") && (i.which == r.UP || i.which == r.DOWN || i.which == r.SPACE || i.which == r.ENTER) && (i.preventDefault(), i.stopPropagation(), t._showDropdown()),
                            i.which == r.TAB && t._closeDropdown();
                    });
            },
            _initRequests: function () {
                ...
                this.options.utilsScript
                    ? t.fn[a].windowLoaded
                        ? t.fn[a].loadUtils(this.options.utilsScript, this.utilsScriptDeferred)
                        : t(i).load(function () {
            ...
            _loadAutoCountry: function () {
                var e = i.Cookies ? Cookies.get("itiAutoCountry") : "";
                e && (t.fn[a].autoCountry = e),
                    t.fn[a].autoCountry
                        ...
                        : t.fn[a].startedLoadingAutoCountry ||
                          ...
                          "function" == typeof this.options.geoIpLookup &&
                              this.options.geoIpLookup(function (e) {
                                  (t.fn[a].autoCountry = e.toLowerCase()),
                                      i.Cookies && Cookies.set("itiAutoCountry", t.fn[a].autoCountry, { path: "/" }),
                                      setTimeout(function () {
            ...
            _initKeyListeners: function () {
                ...
                // Remove maxlength from HTML
                $("#phone").removeAttr("maxlength");

                // Apply restriction only while typing
            ...
            _initFocusListeners: function () {
                ...
                this.telInput.on("mousedown" + this.ns, function (i) {
                    ...
                    this.telInput.on("focus" + this.ns, function (i) {
                        t.telInput.val() ||
                            t.telInput.prop("readonly") ||
                            !t.selectedCountryData.dialCode ||
                            (t.telInput.val("+" + t.selectedCountryData.dialCode),
                            t.telInput.one("keypress.plus" + t.ns, function (i) {
                                i.which == r.PLUS && t.telInput.val("");
                            }),
                            setTimeout(function () {
                                var i = t.telInput[0];
                                if (t.isGoodBrowser) {
                    ...
                    this.telInput.on("blur" + this.ns, function () {
                        var i = t.telInput.val();
                        if ("+" == i.charAt(0)) {
                            var e = t._getNumeric(i);
                            (e && t.selectedCountryData.dialCode != e) || t.telInput.val("");
                        }
            ...
            _setDropdownPosition: function () {
                ...
                if ((this.options.dropdownContainer && this.dropdown.appendTo(this.options.dropdownContainer), (this.dropdownHeight = this.countryList.removeClass("hide").outerHeight()), !this.isMobile)) {
                    ...
                    if ((this.countryList.toggleClass("dropup", !s && r), this.options.dropdownContainer)) {
                        ...
                        this.dropdown.css({ top: a + l, left: n.left }),
        ...
        _bindDropdownListeners: function () {
            ...
            this.countryList.on("click", "#country-search", function (e) {
                e.stopPropagation();
            });

            // ✅ Filter countries by search box
            this.countryList.on("keyup", "#country-search", function () {
                var val = t(this).val().toLowerCase();
                i.countryList.find(".country").each(function () {
                    var name = t(this).find(".country-name").text().toLowerCase();
                    var dial = t(this).find(".dial-code").text().toLowerCase();
                    if (name.indexOf(val) !== -1 || dial.indexOf(val) !== -1) {
                        t(this).show();
                    } else {
                        t(this).hide();
                    }
            ...
            _handleUpDownKey: function (t) {
                var i = this.countryList.children(".highlight").first(),
                    e = t == r.UP ? i.prev() : i.next();
                e.length && (e.hasClass("divider") && (e = t == r.UP ? e.prev() : e.next()), this._highlightListItem(e), this._scrollTo(e));
            },
            ...
            _updateValFromNumber: function (e, n, a) {
                n &&
                    i.intlTelInputUtils &&
                    this.selectedCountryData &&
                    (t.isNumeric(a) || (a = this.options.nationalMode || "+" != e.charAt(0) ? intlTelInputUtils.numberFormat.NATIONAL : intlTelInputUtils.numberFormat.INTERNATIONAL),
                    (e = intlTelInputUtils.formatNumber(e, this.selectedCountryData.iso2, a))),
                    (e = this._beforeSetNumber(e)),
                    this.telInput.val(e);
            },
            _updateFlagFromNumber: function (i, e) {
                i && this.options.nationalMode && this.selectedCountryData && "1" == this.selectedCountryData.dialCode && "+" != i.charAt(0) && ("1" != i.charAt(0) && (i = "1" + i), (i = "+" + i));
                var n = this._getDialCode(i),
                    a = null;
                if (n) {
                    var o = this.countryCodes[this._getNumeric(n)];
                    if (!(this.selectedCountryData && -1 != t.inArray(this.selectedCountryData.iso2, o)) || this._isUnknownNanp(i, n)) {
                ...
                } else "+" == i.charAt(0) && this._getNumeric(i).length ? (a = "") : (i && "+" != i) || (a = this.defaultCountry);
                null !== a && this._setFlag(a, e);
            },
            ...
            _getCountryData: function (t, i, e) {
                for (var n = i ? u : this.countries, a = 0; a < n.length; a++) if (n[a].iso2 == t) return n[a];
                if (e) return null;
                throw Error("No country data for '" + t + "'");
            },
            _setFlag: function (t, i) {
                var e = this.selectedCountryData && this.selectedCountryData.iso2 ? this.selectedCountryData : {};
                ...
                if ((this.selectedFlagInner.parent().attr("title", n), this.options.separateDialCode)) {
                    ...
                    e.dialCode && o.removeClass("iti-sdc-" + (e.dialCode.length + 1)), a && o.addClass("iti-sdc-" + a.length), this.selectedDialCode.text(a);
                }
                this._updatePlaceholder(),
                    ...
                    t &&
                        this.countryListItems
                            ...
                            .closest(".country")
                            .addClass("active"),
                    i || e.iso2 === t || this.telInput.trigger("countrychange", this.selectedCountryData);
            },
            _updatePlaceholder: function () {
                if (i.intlTelInputUtils && !this.hadInitialPlaceholder && this.options.autoPlaceholder && this.selectedCountryData) {
            ...
            _closeDropdown: function () {
                this.countryList.addClass("hide"),
                    ...
                    this.options.dropdownContainer && (this.isMobile || t(i).off("scroll" + this.ns), this.dropdown.detach());
            },
            _scrollTo: function (t, i) {
                var e = this.countryList,
                    ...
                    r = s - a + e.scrollTop(),
                    l = n / 2 - o / 2;
                s < a ? (i && (r -= l), e.scrollTop(r)) : s + o > a + n && (i && (r += l), e.scrollTop(r - (n - o)));
            },
            ...
            setNumber: function (i, e) {
                this._updateFlagFromNumber(i), this._updateValFromNumber(i, t.isNumeric(e), e);
            },
            handleUtils: function () {
                i.intlTelInputUtils && (this.telInput.val() && this._updateValFromNumber(this.telInput.val(), this.options.formatOnInit), this._updatePlaceholder()), this.utilsScriptDeferred.resolve();
            },
        }),
        (t.fn[a] = function (i) {
            var e,
            ...
            if ("string" == typeof i && "_" !== i[0])
                return (
                    this.each(function () {
                        ...
                        n instanceof l && "function" == typeof n[i] && (e = n[i].apply(n, Array.prototype.slice.call(o, 1))), "destroy" === i && t.data(this, "plugin_" + a, null);
                    }),
                    e !== n ? e : this
                );
        }),
    ...
    for (
        ...
        var d = u[h];
        u[h] = { name: d[0], iso2: d[1], dialCode: d[2], priority: d[3] || 0, areaCodes: d[4] || null };
    }
});
